...
static const uint8_t artikel_pins[] = {A1, A2, A3}; // Pinanzahl anpassen!
...
void setup()
{
  ...
  pinMode(A1, INPUT_PULLUP); // Artikel 15
  pinMode(A2, INPUT_PULLUP); // Artikel 16
  pinMode(A2, INPUT_PULLUP); // Artikel 17
