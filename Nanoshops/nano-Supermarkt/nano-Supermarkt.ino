...
static const uint8_t artikel_pins[] = {A1, A2, A3, A4, A5, A6}; // Pinanzahl anpassen!
...
void setup()
{
  ...
  pinMode(A1, INPUT_PULLUP); // Artikel 18
  pinMode(A2, INPUT_PULLUP); // Artikel 19
  pinMode(A3, INPUT_PULLUP); // Artikel 20
  pinMode(A4, INPUT_PULLUP); // Artikel 21
  pinMode(A5, INPUT_PULLUP); // Artikel 22
  pinMode(A6, INPUT_PULLUP); // Artikel 23
