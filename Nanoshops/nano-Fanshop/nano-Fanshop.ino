...
static const uint8_t artikel_pins[] = {A1, A2}; // Pinanzahl anpassen!
...
void setup()
{
  ...
  pinMode(A1, INPUT_PULLUP); // Artikel 13
  pinMode(A2, INPUT_PULLUP); // Artikel 14
...
void loop()
{
  ...
  if (digitalRead(A0) == LOW) {
    ...
    if (artikelNr == 0)
      ...
      digitalWrite(4, LOW); //was ist das?
      block = 1;
      len = 18;
