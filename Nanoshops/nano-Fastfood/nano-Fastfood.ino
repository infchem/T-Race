...
void setup()
{
  ...
  pinMode(A1, INPUT_PULLUP); // Artikel 1
  pinMode(A2, INPUT_PULLUP); // Artikel 2
  pinMode(A3, INPUT_PULLUP); // Artikel 3
  pinMode(A4, INPUT_PULLUP); // Artikel 4
  pinMode(A5, INPUT_PULLUP); // Artikel 5
  pinMode(A6, INPUT_PULLUP); // Artikel 6
